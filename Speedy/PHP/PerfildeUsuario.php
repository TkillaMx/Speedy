...
<body>
    ...
    <header>
        ...
        <div class="miperfil">
        <nav>
            <a href="http://localhost/Speedy/PHP/PerfildeUsuario.php" id="miperfil">Mi perfil<img src="http://localhost/Speedy/IMGS/user.png"></a>
        </nav>
...
<a href="http://localhost/Speedy/PHP/Inicio.php">Inicio</a>
    ...
    <div class="container">
        <h1>Mi Perfil</h1>
        <div id="profile-info">
            <p img src="http://localhost/Speedy/IMGS/user.png"></p>
...
<footer>
    ...
    <script src="http://localhost/Speedy/SCRITPS/perfil.js"></script>
</body>
</html>
