...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Speedy/CSS/comentarios.css">
</head>
<body>
    <!--Topbar-->
    <header>
    ...
    <div class="contenedor">
        <div class="izquierda">
          ...
          <h3>Danos tus ideas para brindarte el mejor servicio</h3>
          <p>Nos importa la opinion de nuestros usuarios (Aveces)</p>
          <textarea placeholder="Comentanos para mejorar"></textarea>
...
<script src="http://localhost/Speedy/SCRITPS/comentarios.js"></script>
</html>
